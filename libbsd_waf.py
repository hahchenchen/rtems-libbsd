...
def build(bld):
    ...
    objs01_source = ['freebsd/contrib/wpa/src/ap/ap_drv_ops.c',
    ...
    objs03_source = ['freebsd/bin/hostname/hostname.c',
                     ...
                     'freebsd/lib/libc/gen/getprogname.c',
                     ...
                     'freebsd/lib/libutil/flopen.c',
                     'freebsd/lib/libutil/humanize_number.c',
                     'freebsd/lib/libutil/pidfile.c',
    ...
    objs05_source = ['freebsd/crypto/openssl/crypto/aes/aes_cbc.c',
    ...
    objs06_source = ['freebsd/lib/libc/db/btree/bt_close.c',
    ...
    objs08_source = ['freebsd/contrib/libpcap/bpf_image.c',
